#assignment2
#to generate public and private keys/to share symmetric key using asymmetric encryption/to verify identity/to share messages using symmetric encryption
